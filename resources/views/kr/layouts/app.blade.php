    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark" >
                ...
                <div class="navbar-header" style="padding-right:0px">
                    <a class="navbar-brand" href="{{ route('kr_management_home') }}">
                    ...
                    <!-- Right Side Of Navbar -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('kr_logout') }}"><i class="fa fa-power-off m-r-5 m-l-5"></i> 로그 아웃</a>
                                <div class="dropdown-divider"></div>
                                <div class="p-l-30 p-10"><a href="javascript:void(0)" class="btn btn-sm btn-success btn-rounded">View Profile</a></div>
                                {{-- <form id="logout-form" action="{{ route('kr_logout') }}" method="POST" style="display: none;">
                                    @csrf
                                </form> --}}
                            </div>
                        </li>
        ...
        <aside class="left-sidebar" id="aside">
            <div class="d-flex no-block nav-text-box align-items-center">
                <span style="color:white">사이드 바 메뉴</span>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        @if(Session::get('level')=="1")
                            @include('kr.layouts.sidebar.management')
                        @elseif(Session::get('level')=="2")
                            @include('kr.layouts.sidebar.qualitycontrol')
                        @elseif(Session::get('level')=="3")
                            @include('kr.layouts.sidebar.production')
                        @elseif(Session::get('level')=="4")
                            @include('kr.layouts.sidebar.admin')
                        @endif
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><span class="hide-menu">언어</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li> <a class="waves-effect waves-dark" href="{{ route('checklevel')}}" aria-expanded="false"><img src="{{ asset('img/united-kingdom.png') }}" /><span class="hide-menu">영어</span></a>    
                                </li>
                                <li> <a class="waves-effect waves-dark" href="{{ route('kr_checklevel') }}" aria-expanded="false"><img src="{{ asset('img/south-korea.png') }}" /><span class="hide-menu">한국어</span></a>    
                                </li>
                            </ul>
                        </li>
